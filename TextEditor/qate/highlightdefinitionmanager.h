...
namespace Qate{
	...
	class HighlightDefinitionManager : public QObject
	{
		...
		public:
			...
			bool removeDefinitionPath(const QString& str);
			bool removeDefinitionPath(int id);
			void clearDefinitionPaths();
		...
		private:
			...
			Qate::MimeType gatherDefinitionsMimeTypes();
			QList<TextEditor::Internal::HighlightDefinitionMetaData> parseAvailableDefinitionsList(QIODevice *device) const;
			void clear();

			bool mDownloadingDefinitions;
			bool mRegisteringMimeTypes;
			int mQueuedMimeTypeRegistrations;

			QHash<QString, QString> mIdByName;
			QHash<QString, QString> mIdByMimeType;
			QHash<QString, QSharedPointer<TextEditor::Internal::HighlightDefinition> > mDefinitions;
			QHash<QString, QSharedPointer<TextEditor::Internal::HighlightDefinitionMetaData> > mDefinitionsMetaData;
			QSet<QString> mIsBuilding;

			QStringList mDefinitionPaths;
