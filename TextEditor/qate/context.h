	...
	namespace Internal {
		...
		class Context
		{
			...
			private:
				QString mId;
				QString mName;
				QString mLineBeginContext;
				QString mLineEndContext;
				QString mFallthroughContext;
				QString mItemData;
				bool mFallthrough;
				bool mDynamic;

				QList<QSharedPointer<Rule> > mRules;
				QList<IncludeRulesInstruction> mInstructions;

				QSharedPointer<HighlightDefinition> mDefinition;
		};
