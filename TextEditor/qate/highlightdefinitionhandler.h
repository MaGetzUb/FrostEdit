...
namespace Qate {
	...
	class HighlightDefinitionHandler : public QXmlDefaultHandler
	{
		...
		private:
			...
			bool mProcessingKeyword;
			QString mCurrentKeyword;
			QSharedPointer<TextEditor::Internal::KeywordList> mCurrentList;
			QSharedPointer<TextEditor::Internal::Context> mCurrentContext;
			QStack<QSharedPointer<TextEditor::Internal::Rule> > mCurrentRule;

			bool mInitialContext;
	};
